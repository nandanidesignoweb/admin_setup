...
<html lang="en">
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<!-- <a href="#"> -->
                                <img src="<?php echo base_url('public/front/img/logo2.png');?>">
							<!-- </a> -->
						</div>
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" id="common-form" action="<?php echo base_url('admin/check_login');?>">
                                <div class="error_msg" id="error_msg"></div>
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="text" placeholder="Email" name="email" id="email" autocomplete="off">
								</div>
								<div class="form-group m-form__group">
									<input class="form-control m-input m-login__form-input--last" type="password"  id="password" placeholder="Password" name="password" autocomplete="off">
								</div>
        ...
        <script src="<?php echo base_url('assets/vendors/base/event.js')?>" type="text/javascript"></script>
