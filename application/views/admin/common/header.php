										 ...
										 m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												...
												<?php if(!empty($admin_detail['image_url'])){?>
													<img src="<?php echo base_url('assets/admin/profilePic/'.$admin_detail['image_url'])?>" class="m--img-rounded m--marginless"alt="" />
												<?php }else{?>
													<img src="<?php echo base_url('assets/admin/profilePic/profile_icon.png')?>" class="m--img-rounded m--marginless" alt="" />
												<?php }?>
												</span>
													...
													<div class="m-dropdown__header m--align-center" style="background: url(<?php echo base_url('assets/app/media/img/misc/user_profile_bg.jpg')?>); background-size: cover;">
														<div class="m-card-user m-card-user--skin-dark">
															...
															<div class="m-card-user__details">
																<span class="m-card-user__name m--font-weight-500"><?php echo $admin_detail['name'];?></span>
